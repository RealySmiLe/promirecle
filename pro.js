...
const w = ['./img/up1.png','./img/up2.png','./img/up.png'];
  ...
  .setColor("GRAY")
  .setAuthor(message.user.avatarURL)
...
const w = ['./img/up1.png','./img/up2.png','./img/up.png'];
  ...
  if (message.content.startsWith(prefix + 'OWNER')) {
        if(!message.channel.guild) return message.reply('** This command only for servers**');
    if(message.author.user !== '454527533279608852' && message.author.id !== '415602689100087297') return message.reply('**This Command Just For Admins**')// :|
    console.log(args[0]);
